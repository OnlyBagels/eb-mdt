...
const BOLOPage: React.FC = () => {
  ...
  const [boloToDeactivate, setBoloToDeactivate] = useState<number | null>(null);
  ...
  const openConfirmModal = (boloId: number) => {
    setBoloToDeactivate(boloId);
    setConfirmModalOpen(true);
  };

  const closeConfirmModal = () => {
    setBoloToDeactivate(null);
                  ...
                  <tr key={bolo.id}>
                    ...
                    <td>
                      <div className="flex gap-2">
                        ...
                        <button
                          onClick={() => openConfirmModal(bolo.id)}
          ...
          <div className="modal-container max-w-sm">
            ...
            <div className="modal-content">
              <p className="text-white">
                Are you sure you want to deactivate this BOLO? This action
                cannot be undone.
              </p>
            </div>
            ...
            <div className="modal-footer">
              ...
              <button
                ...
                className="mdt-button bg-red-600 hover:bg-red-700 text-white"
              >
